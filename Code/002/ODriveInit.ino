...
void OdriveInit1() {
      ...
      for (int axis = 0; axis < 2; ++axis) {
          ...
          Serial1 << "w axis" << axis << ".motor.config.current_lim " << 35.0f << '\n';
          ...
          Serial1 << "w axis" << 0 << ".controller.config.vel_integrator_gain " << 0.5 << '\n';
          Serial1 << "w axis" << 1 << ".controller.config.vel_integrator_gain " << 0.5 << '\n';
      }   
